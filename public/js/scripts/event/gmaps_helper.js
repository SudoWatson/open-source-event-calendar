/** NOTE: 
    * This used to be the source of truth for this content
    * It appears to have been built into js/pages/event.js
    * This code is never ran. See js/pages/event.js for the used code
    */
